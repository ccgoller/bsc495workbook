...
- [ ] Scalpel
- [ ] 70% ethanol
- [ ] Beaker or autoclavable container for cellophane and ethanol
- [ ] Parafilm
- [ ] Ruler
- [ ] Fine-tip Sharpie or marker for labeling plates
...
- [ ] Beaker or autoclavable container for ethanol
- [ ] Scalpel
- [ ] Ruler
- [ ] Forceps
- [ ] Autclave
...
2. **Label a PDA Petri dish with the sample number and date for each isolate** (described in Module 1.1 - Metadata). Always label along the bottom edge. This ensures the label stays with the fungus, even if the top lid falls off. Label the edge of the plate because you don't want to obscure light transmission through the plate. Also, mark lines on the bottom of the plate to record the growth rate. Be sure to transfer only one fungal isolate to each PDA Petri dish.
3. Use a sterilized scalpel, forceps, and agar punch. 
4. Make a "plug". Cut a small chunk of water agar containing hyphae of target isolate using a sterilized scalpel or agar punch. Transfer this plug of agar and hyphae to the PDA plate. Ideally, you will have the least amount of agar transferred to the new Petri dish.
...
1. Design a data sheet to record growth as indicated in @fig-measuregrowth.
2. On the bottom of the plate, trace the edge of your fungal culture using a fine-tip Sharpie or marker.

![Measure Growth on PDA Plates. Divide the plate into eight segments using a ruler and marker. Then measure the growth at each segment starting at the end of the water agar plug and ending at the edge of the growth. Image the plate from top and bottom. Record measurements and images in your lab notebook. Figure created with BioRender.com.](images/MeasureGrowthPDA.png){#fig-measuregrowth fig-alt="Measure Growth on PDA Plates by Dividing Plate into Eight Segments and Meauring from Agar Plug to Edge of Growth." fig-align="center" lightbox="true"}
...
8. Submit images and your data sheet and a graph of growth rates in your lab blog post for this project. Please take images to add to your lab notebook.