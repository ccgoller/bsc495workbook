...
* Labeling tape
* Spin Genomic DNA Extraction Kit (New England BioLabs)
* Metapolyzyme (Millipore)
* TE Buffer
* CTAB solution (Promega)
* Parafilm
* 70% ETOH
* 1-10 and 20-200 µL micropipettors
* 1-10 and 20-200 µL micropipette tips (preferably filtered)
* Kimwipes
* PCR primers (ITS1f, ITS4, 5.8SR, fITS7)
* Polymerase master mix (New England BioLabs Q5 2x Master Mix)
* PCR water
