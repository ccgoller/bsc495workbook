...
::: {.callout-tip}
### 📽️ Open Slides
[Open Module 1 Slides](module1-slides.html)
:::
...
- [ ] Ethanol
- [ ] Sterile water
- [ ] Streptomycin (50 mg/ml stock solution)
...
**Water Agar Plates:**
Student scholars isolate fungal endophytes from leaves on water agar. We use one 100x15mm Petri dish to plate up to 6 leaf discs (@fig-Wateragar).
...
Record metadata on the [**Endophyte spreadsheet**](https://docs.google.com/spreadsheets/d/1mwfepj-iDCfE9ZHvsbBmc7eAuIUaboug/edit?usp=sharing&ouid=105826871227022710667&rtpof=true&sd=true). We will continue adding to this spreadsheet as we collect more data on our fungal isolates. This spreadsheet will be shared with you and your instructor/TA.

### iNaturalist Plant Observation
[NC State Myco Ed on iNaturalist](https://www.inaturalist.org/projects/nc-state-myco-ed)

### Sample Naming
Your individual fungal isolates will be identified using several identifiers. The first will be the unique **Host ID number from iNaturalist** that identifies the host for the fungi you isolate. Second will be **your initials**. Please use at least 3 initials since some large courses may have students with shared initials. Third, **each individual leaf you cultured fungi from will be a separate number**. If you take multiple samples from the same leaf, they will be identified by letters. For example, if you have one leaf or needle with 3 different sections, they would be 1a, 1b, and 1c.

**Example:** You have leaves collected from a maple tree on your campus. This tree was logged in iNaturalist and given a unique field number MycoED_004 (or whatever format the field numbers are provided in by your instructor/TA). Let's assume your initials are ABC. From this collection, you have three leaves that you culture from: leaf 1, leaf 2, and leaf 3. From each of these leaves, you take six segments or sections, so these are letters a-f. So, if you isolate a fungus from the second leaf, third section, and your initials are ABC, the name of the isolate would look like MycoED_004_ABC_2c.

With this naming scheme, anyone can trace the 1) plant host, 2) the researcher, 3) and the leaf and leaf section the fungal isolate came from. No other fungus will have this precise labeling unless additional fungi were isolated from this leaf section. After that step you will need to add additional identifiers.
...
From the dropdown menu. The Lat/Long is now shown. Click the copy button and paste it into the [Endophyte spreadsheet](https://docs.google.com/spreadsheets/d/1mwfepj-iDCfE9ZHvsbBmc7eAuIUaboug/edit?usp=sharing&ouid=105826871227022710667&rtpof=true&sd=true).

You can also find latitude/longitude coordinates on Google Maps.

#### For Android phones 
1. Tap on the location. 
2. Copy the latitutde/longitude coordinates.
3. Paste the information. The text is automatically in decimal degree format.
...
### Canopy
Record the portion of the canopy where the leaf was collected:

| Canopy Location | Portion |
|-------------|-------|
| **L-lower** | Lower 1/3 of plant |
| **M-middle** | Middle 1/3 of plant |
| **U-upper** | Upper 1/3 of plant |
: Table 1. Canopy location of leaf sample collection. {#tbl-canopy-location}

## Module 1.3 – Using iNaturalist

### Using iNaturalist
We will be sampling plant tissue and isolating endophytic fungi for an experiment in fungal genomics. Part of this research will include the collection of important meta-data which includes latitude and longitude information, sampled material/host, and taxonomic information. To facilitate this we are using iNaturalist.
...
- Add your name to iNaturalist or coontact your instructor with the information you will want to use and share.
...
Our protocol will be specific to our project, but we will borrow from any/all of the video guides shown above.
...
2. Make an observation of one host plant by taking a picture of it.
   ...
   b. Include one field label in an image of the plant. (review examples)
   c. Take images from multiple perspectives: whole plant, leaves, flowers & fruits, branches, trunk...
...
::: {.callout-tip}
You must join the course project before this step. Refer to the third bullet point at the beginning of these instructions.
:::
...
## Module 1.4 – Fungal Sampling and Culturing

### Purpose
This lab session will introduce you to sterile/aseptic technique, culturing, isolating, and documenting fungal growth.
...
- [ ] Sharpie or marker for labeling plates
- [ ] Parafilm
- [ ] Paper towels
- [ ] Gloves
- [ ] Bleach
...
2. Make an iNaturalist observation of the plant on your phone or device.
   a. Take multiple photos.
      ...
      ii. Multiple closer pictures of the leaves, bark, any flowers or fruit...
...
You have 3 larger (150x10mm) Petri dishes that contain water agar. Water agar media is more clear (whitish to translucent) than the smaller Petri dishes which contain Potato Dextrose Agar (PDA). These water agar plates will be used for Part I of this exercise. Section each of these into 6 regions as depicted in @fig-Wateragar. This will provide you space to culture 18 leaf sections.
...
Label the @fig-Wateragar plate with your name and divide into six sections. Label each section with the unique ID number for the leaf sample you will be plating in that section. For example, if you are plating leaf 1a in the first section, label that section "1a". If you are plating leaf 2b in the second section, label that section "2b", and so on.

![Water Agar Plates. Take a large water agar plate and divide it into six sections using a ruler and marker. Label each section with the unique ID number for the leaf sample you will be plating in that section. Figure created with BioRender.com.](images/WaterAgar.png){#fig-Wateragar fig-alt="Water agar plate division into sections and labeling." fig-align="center" lightbox="true"}


1. Sanitize/sterilize all work surfaces. Wipe surfaces with ethanol. Choose a working location with the least amount of airflow to prevent contamination. 
2. Sterilize tools (scalpel or hole punch and forceps). Use ethanol and allow to air dry.
...
6. Add tissue to water agar. Place up to 6 leaf cuttings per plate of water agar labeled as described @fig-SamplesWaterAgar. The water agar plates are the larger plates that contain clear to whitish media. Use sterile technique. Be sure to sterilize forceps (heat with flame and cool) in between each leaf transfer.
7. Seal the Petri dish with Parafilm. This is a stretchy material similar to Saran Wrap. Cut a strip a little wider than the Petri dish. Remove the paper backing. Hold one end of the Parafilm strip on the lip of the Petri dish so that the gap between the lid and base is covered by the Parafilm. Keeping one end fixed with one hand, stretch and wrap the parafilm around the Petri dish, sealing the gap between the lid and base of the Petri dish. The stretching of the Parafilm will facilitate the seal, you will not need any tape to keep the Parafilm in place.
8. Incubate at room temperature in the dark and examine for growth each day.

![Place Leaf Samples on Water Agar Plates. Take a large water agar plate and divide it into six sections using a ruler and marker. Place leaf samples in each section after surface sterilizing and rinsing in ethanol. Figure created with BioRender.com.](images/LeafSamplesWaterAgar.png){#fig-SamplesWaterAgar fig-alt="Place leaf samples on water agar plates." fig-align="center" lightbox="true"}
