...
![Fungal Sampling. Leaves have different shapes and sizes. Leaf pathologies and diseases can be identified by inspection of leaves. Figure created with BioRender.com.](images/LeafPathologies.png){fig-alt="Plant Leaf Pathologies." fig-align="center" #fig-leafpathologies lightbox="Plant Leaf Pathologies"}
...
![](images/LeafSampling.png){fig-alt="Fungal Sampling.Collect one sample/leaf per bag and complete the required information on each label."fig-align="center" #fig-LeafSampling lightbox="Leaf sampling"}
